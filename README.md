...
![](http://latex.codecogs.com/svg.latex\begin{aligned}&\text{lerp}(k,v0,v1)=v0+k(v1-v0);\\\\&u0 = \text{lerp}(s,u00,u10);\\\\&u1=\text{lerp}(s,u01,u11);\\\\&f(x,y)=\text{lerp(t,u0,u1);\end{aligned})
