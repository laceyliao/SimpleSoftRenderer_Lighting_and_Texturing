...
namespace TinyRenderer
{
	...
	public:
		...
		static int addSpotLight(glm::vec3 pos, glm::vec3 dir, float angle, float outerangle, glm::vec3 atten, glm::vec3 color);//spot light
		static TRPointLight &getPointLight(int index);
		static TRSpotLight& getSpotLight(int index);//get spot light
