...
namespace TinyRenderer
{
	...
	int TRRenderer::addSpotLight(glm::vec3 pos, glm::vec3 dir, float angle, float outerangle, glm::vec3 atten, glm::vec3 color)
	{
		return TRShadingPipeline::addSpotLight(pos, dir, angle, outerangle, atten, color);
	}
