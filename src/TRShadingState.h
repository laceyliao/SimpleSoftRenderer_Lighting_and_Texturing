...
namespace TinyRenderer
{
	...
	public:
		...
		TRSpotLight(glm::vec3 pos,glm::vec3 dir,float angle, float outerangle, glm::vec3 atten, glm::vec3 color)
			:lightPos(pos),direction(dir),cutOff(angle),outercutOff(outerangle), attenuation(atten), lightColor(color) {}
	};
}
